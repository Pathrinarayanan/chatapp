...
public class excitedAdapter extends RecyclerView.Adapter<excitedAdapter.MyViewHolder> {
    ...
    public excitedAdapter(Context context, List<Chats> chatslist, String imageURL) {
