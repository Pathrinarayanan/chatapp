...
public class connectionReqAdapter extends RecyclerView.Adapter<connectionReqAdapter.ViewHolder> {
    ...
    public connectionReqAdapter(Context mContext, OnItemClick onItemClick, List<Requests> mUsers, boolean ischat){
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        Requests user = mUsers.get(position);
        ...
        holder.btn_follow.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(current_state.equals("nothing_happend")){
                    ...
                    reqreference.child(firebaseUser.getUid()).updateChildren(hashMap).addOnCompleteListener(new OnCompleteListener() {
                        @Override
