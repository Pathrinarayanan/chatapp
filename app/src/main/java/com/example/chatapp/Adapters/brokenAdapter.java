...
public class brokenAdapter extends RecyclerView.Adapter<brokenAdapter.MyViewHolder> {
    ...
    public brokenAdapter(Context context, List<Chats> chatslist, String imageURL) {
