...
public class attachedAdapter extends RecyclerView.Adapter<attachedAdapter.MyViewHolder> {
    ...
    public attachedAdapter(Context context, List<Chats> chatslist, String imageURL) {
