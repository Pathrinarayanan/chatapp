...
public class confusedAdapter extends RecyclerView.Adapter<confusedAdapter.MyViewHolder> {
    ...
    public confusedAdapter(Context context, List<Chats> chatslist, String imageURL) {
